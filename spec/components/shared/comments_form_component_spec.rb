...
describe Shared::CommentsFormComponent do
  context "Legislation annotation" do
    it "Comments are disabled when the allegations phase is closed" do
      ...
      render_inline Shared::CommentsFormComponent.new(annotation)
  ...
  context "Legislation question" do
    ...
    it "Unverified user can't create comments" do
      unverified_user = create(:user)
      sign_in unverified_user

      render_inline Shared::CommentsFormComponent.new(question)

      expect(page).to have_content "To participate verify your account"
    end

    it "Can't create comments if debate phase is not open" do
